...
const signInPage = () => {
  ...
  return (
    <main className="flex items-center justify-center bg-gradient-to-b from-white via-amber-50 to-white                     md:py-16 py-9 ">
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        <Form className="bg-white shadow-lg rounded-lg w-3xl md:w-md p-8 space-y-6 ">
          <div className="text-center">
            <h1 className="text-3xl font-semibold text-gray-800">
              Login to <span className="text-amber-500 text-3xl font-bold">My Notes</span>
            </h1>
          </div>
