...
const linkClass =
  "relative text-gray-800 text-lg after:content-[''] after:absolute after:bottom-0 after:left-1/2 " +
    ...
    <footer className="bg-amber-50 text-gray-800 border-t border-gray-300 mt-8 px-6 py-6">
      ...
      <div className="text-center text-lg mt-4 flex justify-center items-center gap-2">
        ...
        <span>
          ...
          <span className="text-amber-500 font-bold">MY NOTES</span>. All rights reserved.
        </span>
      </div>
    </footer>
  );
